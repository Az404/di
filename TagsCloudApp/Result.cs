...
namespace TagsCloudVisualization
{
    ...
    public static class Result
    {
        ...
        public static Result<T> Validate<T>(this T obj, Func<T, bool> predicate, string errorMessage)
        {
        ...
        public static Result<TOut> TranslateFail<TIn, TOut>(this Result<TIn> obj)
        {
            return Result.Fail<TOut>(obj.Error);
        }
    }
}